-- |
-- Module      : Streamly.Benchmark.Data.Splitter
...
import qualified Streamly.Internal.Data.Splitter as SP
...
any value = IP.runSplitter (SP.any (> value))

{-# INLINE all #-}
all :: (Monad m, Ord a) => a -> SerialT m a -> m Bool
all value = IP.runSplitter (SP.all (<= value))
{-
{-# INLINE zipAllAny #-}
...
o_1_space_serial_splitter :: Int -> [Benchmark]
o_1_space_serial_splitter value =
